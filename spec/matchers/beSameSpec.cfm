...
<describe hint="Be Same">
  ...
  <before>
    <cfset matcher = createObject("component", "cfspec.lib.matchers.BeSame")>
  </before>

  <it should="match when actual and expected are equivalent simple values">
    <cfset $matcher = $(matcher.init("foo"))>

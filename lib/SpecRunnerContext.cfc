<cfcomponent extends="Base" output="false"><cfscript>
  ...
  function init(spec) {
    ...
    $keywords = "RUNSPEC,RUNSPECFILE,RUNSPECSUITE,$,$EVAL,STUB,MOCK,FAIL,PEND,THIS,$CFSPEC,CFSPECBINDINGS,DESCRIBESTARTTAG,BEFOREALLSTARTTAG,BEFOREALLENDTAG,BEFORESTARTTAG,BEFOREENDTAG,ITSTARTTAG,ITENDTAG,AFTERSTARTTAG,AFTERENDTAG,AFTERALLSTARTTAG,AFTERALLENDTAG,DESCRIBEENDTAG";
    $current = "0";
    $context = [];
    $contextStatus = [];
    $targets = [];
